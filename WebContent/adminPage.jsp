...
<body>
	...
	<%
		...
		while(rs.next()){
			...
			out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td><a href='edit.jsp?id="+id+"'>修改</a> <a href='del.jsp?id="+id+"'>删除</a> <a href='visit.jsp?id="+id+"'>查看</a></td></tr>");
		}
		rs.close();
		stmt.close();
		con.close();
